    ...
    for epoch in range(epoch_max):
        ...
        for example_id in range(train_size):  # this loop accumulates a batch
            ...
            if args.social_equity == 1:
                ...
                reward_od = metro_vrp.reward_fn1(tour_idx_cpu, grid_num, agent_grid_list, line_full_tensor, line_station_list,
                                              exist_line_num, od_matirx, args.grid_x_max, args.dis_lim)  # CPU
                agent_Ac = metro_vrp.agent_grids_price_gini(tour_idx_cpu, args.grid_x_max, price_matrix)  # cpu
                ...
                if args.od_gini == 1:
                    ...
                    reward = metro_vrp.reward_fn1_total_od_times_gini(tour_idx_cpu, grid_num, agent_grid_list, line_full_tensor, line_station_list,
                                      exist_line_num, od_matirx, args.grid_x_max, args.dis_lim)
                elif args.od_gini == 6:
                    reward = metro_vrp.reward_fn1_group_times_gini(tour_idx_cpu, grid_num, agent_grid_list, line_full_tensor, line_station_list,
                                      exist_line_num, od_matirx, args.grid_x_max, args.dis_lim, df_ses, group_masks, group_od)
                else:
